...
namespace NetTool
{
    ...
    public class Net
    {
        static string url = "www.baidu.com;www.sina.com;www.163.com;www.csdn.com";
        static string[] urls  = url.Split(new char[] { ';' });

        //public Net()
        //{
        //    this.urls = url.Split(new char[] { ';' });
        //}

        /// <summary>
        /// 正常
        /// </summary>
        public static int LEVEL1 { get; private set; }
        /// <summary>
        /// 不稳定
        /// </summary>
        public static int LEVEL2 { get; private set; }
        /// <summary>
        /// 异常
        /// </summary>
        public static int LEVEL3 { get; private set; }
        /// <summary>
        /// 连接丢失
        /// </summary>
        public static int LEVEL4 { get; private set; }

        /// <summary>
        /// 检测网络连接状态
        /// </summary>
        /// <param name="urls"></param>
        public static int CheckServeStatus()
        {
